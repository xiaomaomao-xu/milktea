...
import com.hsys.tea.milktea.wenxin.wxutils.WXPayConstants.SignType;

public class WXPay {

    private WXPayConfig config;
    private SignType signType;
    private SignType signType2;
    ...
    public Map<String, String> fillRequestData2(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("nonce_str", WXPayUtil.generateNonceStr());
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType2));
        return reqData;
    }
    ...
    public Map<String, String> deposit(Map<String, String> reqData) throws Exception{
		return deposit(reqData,this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    } 
    
    public Map<String, String> deposit( Map<String, String> reqData,int connectTimeoutMs, int readTimeoutMs) throws Exception{
    	String url=WXPayConstants.Enterprise_payment;
